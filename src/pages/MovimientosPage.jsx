...
const MovimientosPage = () => {
  const { movimientos, total, loadingMovimietos } =
    ...
    <TemplatePrincipal>
      <section className="pt-8 grid gap-4">
        <header className="flex items-center justify-between bg-[#025864] p-4 rounded-lg shadow-md">
          <div>
            <h2 className="text-white text-lg">Total de dinero que debes</h2>
            <p className="text-white text-2xl">{formatearPrecio(total)}</p>
          </div>

          <div>
            <button
              type="button"
              className="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-[#0b505a] rounded-lg border border-gray-700 duration-200 hover:bg-[#025864] hover:text-stone-300 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
